...
public class ProcessMailbox extends Mailbox {
	
	int count = 0;
	long time = 0;
	
	private static Logger log = Logger.getLogger(ProcessMailbox.class);
	
	public ProcessMailbox(ExchangeSpace es, ExchangeName en, Queue q) {
		super(es, en, q);
